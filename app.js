...
// Esprit Lotus SVG paths for consistent icon replacement
const LOTUS_SVG_PATHS = `
  <path fill="currentColor" d="M643.5,901.04c-18.06-.14-36.08-.29-54.12-1.79-32.34-2.7-64.27-7.45-95.63-15.58-32.61-8.45-63.79-20.29-92.98-36.72-24.08-13.55-45.8-30.15-66.78-47.71-3.43-2.87-6.55-6.99-10.54-8.08-4.26-1.16-9.41,.43-14.13,1.1-25.57,3.64-50.88,8.44-75.87,14.87-62.87,16.19-121.82,40.86-176.47,74.84-1.57,.98-3.11,2.02-5.09,3.32,1.98,1.26,3.4,2.23,4.89,3.09,49.61,28.55,102.2,50.38,158.1,64.88,33.71,8.75,67.82,15.49,102.53,19.12,18.64,1.95,37.37,3.2,56.09,4.27,44.33,2.54,88.01-1.49,131.04-12.22,50.78-12.66,98.08-32.93,142.65-59.28,1.6-.95,3.14-1.97,4.72-2.96-.17-.39-.35-.77-.52-1.16-2.63,0-5.27,.02-7.9,0Z"/>
  <path fill="currentColor" d="M334.98,759.2c11.29-.9,22.6-1.52,33.9-2.25,27.86-1.81,55.58-.38,83.13,3.7,29.63,4.39,58.49,11.82,86.75,21.41,24.56,8.34,48.29,18.52,71.64,29.57,1.48,.7,3.03,1.26,4.55,1.89,0-1.4-.39-2.13-.87-2.79-5.56-7.66-11.36-15.17-16.68-22.98-25.72-37.69-46.24-77.82-61.07-120.59-12.11-34.94-20.12-70.7-23.12-107.43-.28-3.35-1.82-5.05-4.69-6.64-68.57-37.78-142.47-57.66-221.38-60.59-27.64-1.03-55.24-.16-82.73,2.92-5.76,.64-11.5,1.51-17.85,2.35,.4,2.58,.65,4.73,1.07,6.84,9.29,46.54,25.9,90.53,49.33,132.26,24.59,43.79,54.39,83.86,90.7,119.44,2.14,2.09,4.16,3.17,7.34,2.92Z"/>
  <path fill="currentColor" d="M786.61,815.1c-.71,.87-1.28,1.84-1.97,2.85,.64,.12,1.04,.33,1.31,.23,1.31-.49,2.61-1.01,3.86-1.63,43.01-21.58,87.97-38.17,135.31-48.66,29.78-6.6,59.91-10.53,90.5-9.99,20.17,.35,40.33,1.57,60.47,2.72,3.63,.21,5.87-.73,8.2-3.2,55.71-58.85,98.08-125.24,124.01-200.99,6.35-18.54,11.94-37.28,16.89-56.77-2.1-.46-3.61-.92-5.17-1.1-9.31-1.07-18.61-2.34-27.95-3.04-34.85-2.63-69.65-2.68-104.42,1.63-34.14,4.23-67.68,10.91-100.46,21-29.73,9.15-58.45,20.58-85.79,35.14-2.98,1.59-4.21,3.35-4.55,6.64-1.1,10.63-2.38,21.27-4.14,31.82-7.18,42.88-21.35,83.66-40.88,122.76-17.89,35.81-39.78,69.27-65.21,100.6Z"/>
.54-21.01,72.43-19.68,110.6,.08,2.31,.77,3.68,2.95,4.82,5.11,2.7,10.28,5.39,15.02,8.62,25.82,17.62,49.06,37.85,68.2,62.25,20.57,26.22,36.65,54.82,49.9,84.96,10.18,23.16,19.1,46.74,25.38,71.19,1.13,4.38,2.51,8.7,4.09,14.14,2.74-9.46,4.96-17.66,7.49-25.78,11.28-36.19,25.23-71.33,44.57-104.35,14.37-24.55,31.34-47.22,52.02-67.3Z"/>
  <path fill="currentColor" d="M847.51,875.65c24.88-2.42,49.33-6.76,73.34-13.45,49.65-13.84,92.4-38.78,129.13-74.36-1.1-.12-1.94-.29-2.78-.29-13.98,0-27.98-.44-41.93,.16-14.64,.63-29.32,1.67-43.84,3.58-27.75,3.66-54.73,10.62-81.17,19.44-42.25,14.1-82.29,32.68-120.56,54.86-4.49,2.6-8.9,5.31-13.81,8.25,1.15,.5,1.57,.82,2.01,.86,4.4,.39,8.8,.76,13.21,1.08,28.8,2.08,57.58,2.68,86.39-.12Z"/>
`;

/**
 * Create a new Lotus SVG element with consistent styling
 * @param {string|number} size - Height and width (e.g., '34px' or 34)
 * @param {boolean} isInline - Whether to use inline-block display
 * @returns {SVGElement}
 */
function createLotusSvg(size, isInline = false) {
  const svgSize = typeof size === "number" ? `${size}px` : size;
  const svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  svg.setAttribute("height", svgSize);
  svg.setAttribute("width", svgSize);
  svg.setAttribute("viewBox", "0 0 1400 1400");
  svg.style.display = isInline ? "inline-block" : "block";
  if (isInline) {
    svg.style.verticalAlign = "middle";
  }
  svg.innerHTML = LOTUS_SVG_PATHS;
  return svg;
}
...
function replaceFeatureIconSvg() {
  try {
    // Replace all feature list icons
    const featureIconElements = document.querySelectorAll('#tile-feature-list-M5ktKX .ins-tile__feature-icon svg');
    featureIconElements.forEach(element => {
      replaceSvgWithLotus(element);
    });
    if (featureIconElements.length === 0) {
      console.warn('Feature icon SVGs not found: #tile-feature-list-M5ktKX .ins-tile__feature-icon svg');
    }

    // Replace announcement bar text character with SVG
    const announcementTextElement = document.querySelector('#tile-announcement-bar-g3Yn8u .ins-tile__text');
    if (announcementTextElement) {
      const computedStyle = getComputedStyle(announcementTextElement);
      const fontSize = parseFloat(computedStyle.fontSize) || 16;
      const svgSize = `${fontSize * 1.643}px`;
      
      const newSvg = createLotusSvg(svgSize, true);
      ...
      if (originalText && originalText.includes('𖡼')) {
        ...
        if (parts[0]) announcementTextElement.appendChild(document.createTextNode(parts[0]));
        announcementTextElement.appendChild(newSvg);
        if (parts[1]) announcementTextElement.appendChild(document.createTextNode(parts[1]));
...
function replaceSvgWithLotus(targetElement) {
  try {
    ...
    const isInline = getComputedStyle(targetElement).display.includes('inline');
    const newSvg = createLotusSvg(currentHeight, isInline);

...
function replaceFeatureIconSvg() {
  try {
    // Replace all feature list icons (not just the first one)
    ...
    if (announcementTextElement) {
      // Get current text content height to preserve sizing
